  ...
  <div class="resume" id="resume1">
    ...
    <div class="left half">
      ...
      <div class="experience">
        ...
        <div class="experience-block" v-for="contribution in person.contributions" :key="contribution.name">
          <span class="company"> {{contribution.name}} </span>
          <span class="job-description"> {{contribution.description}} </span>
          <span class="job-title"> <a :href="contribution.url">{{contribution.url}}</a></span>
        </div>
      </div>
      <div class="contact">
        <h3>{{ lang.contact }}</h3>
        <table>
          ...
          <tr v-if="person.contact.github">
            <td><a :href="'https://github.com/'+person.contact.github">https://github.com/{{person.contact.github}}</a>
            </td>
    ...
    <div class="right half">
      ...
      <div class="experience">
        ...
        <div class="experience-block" v-for="project in person.projects" :key="project.name">
          ...
          <span class="job-title"> {{project.platform}} </span>
      ...
      <div class="skills">
        ...
        <div class="skill-block">
          ...
          <span class="skill-text">Be willing to learn</span>
        </div>
      </div>
